...
const convert = async (): Promise<any> => {
  ...
  const deleteAction = (action: Actions): void => {
  ...
  if (actions.length) {
    return (
      <div className="space-y-6 relative -inset-x-32">
        {actions.map((action: Actions, i: any) => (
          <div
            key={i}
        ...
        <div className="flex w-full justify-center">
          {is_done ? (
            ...
            <Button
              ...
              className="rounded-xl font-semibold relative py-6 text-md flex items-center w-44 justify-center "
              onClick={convert}
            >
              {is_converting ? (
